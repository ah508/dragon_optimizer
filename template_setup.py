...
hbh_tree = build_tree(NO_BOOST, include_all=[1, 2, 3, 4, 'C3a_skl', 'C3a_end', 'C3b_skl', 'C3b_end', 'W', 'D', 'S'])
rpos_tree = build_tree(REBORN_PZ, include_all=[1, 2, 3, 'W', 'D', 'S'])
rzeph_tree = build_tree(REBORN_PZ, include_all=[1, 2, 3, 4, 5, 'W', 'D', 'S'])
threehitdelay = build_tree(NO_BOOST, include_all=[1, 2, 3, 'C3_skl', 'C3_end', 'W', 'D', 'S'])
...
reborn_zeph = Make_Constraints(rzeph_tree)
...
generate_reborn_pz(reborn_pos, 3, C_3MAP, 'reborn_pos')
generate_reborn_pz(reborn_zeph, 5, C3ABC_3MAP, 'reborn_zeph')
