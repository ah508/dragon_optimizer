...
def generate_leviathan(constraint_class, n_attacks, d_map, file_name):
    ...
    constraint_class.add_rule('Normal', 1, ['Normal', 'Normal', 'Normal', 'Normal'], [2, 'C2_END', 'D', 'S'])
    constraint_class.add_rule('Boost1_1', 1, ['Boost1_1', 'Boost1_1', 'Boost1_1', 'Exit1_1'], [2, 'C2_END', 'D', 1])
    constraint_class.add_rule('Exit1_1', 1, ['Normal', 'Normal', 'Normal'], [2, 'C2_END', 'D'])
    constraint_class.add_rule('Normal', 2, ['Normal', 'Normal', 'Normal'], [3, 'D', 'C2_skl'])
    constraint_class.add_rule('Boost1_1', 2, ['Boost1_1', 'Boost1_1', 'Exit1_1'], [3, 'D', 2])
    ...
    # in place of normal staircase:
    constraint_class.add_const(['Normal', 'Normal', 'Normal', 'Exit1_1'], [1, 2, 'C2_END', 1], [-1, 1, 1, -1], '<=', 0)
    constraint_class.add_const(['Normal', 'Normal', 'Normal', 'Exit1_1'], [2, 3, 'C2_skl', 2], [-1, 1, 1, -1], '<=', 0)
    constraint_class.add_const(['Normal', 'Normal', 'Exit1_1'], [3, 'W', 3], [-1, 1, -1], '<=', 0)
    # in place of second staircase
    constraint_class.add_const(['Boost1_1', 'Boost1_1', 'Boost1_1', 'Exit1_1'], [1, 2, 'C2_END', 1], [-1, 1, 1, 1], '<=', 0)
    constraint_class.add_const(['Boost1_1', 'Boost1_1', 'Exit1_1'], [2, 3, 2], [-1, 1, 1, 1], '<=', 0)
    constraint_class.add_const(['Boost1_1', 'Boost1_1', 'Exit1_1'], [3, 'W', 3], [-1, 1, 1], '<=', 0)

    constraint_class.add_const(['Normal', 'Normal', 'Normal'], [1, 'W', 'D'], [1, -1, -1], '<=', 1)
    constraint_class.add_const(['Normal', 'Boost1_1', 'Boost1_1', 'Boost1_1'], ['S', 1, 'W', 'D'], [-1, 1, -1, -1], '<=', 0)
    constraint_class.add_const(['Exit1_1', 'Exit1_1', 'Exit1_1', 'Boost1_1'], [1, 2, 3, 'C2_END'], [1, 1, 1, 1], '<=', 1)
